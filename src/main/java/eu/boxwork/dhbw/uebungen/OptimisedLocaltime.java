 ...
 */
public class OptimisedLocaltime {
    private static final int GID = 00;
    private static final int PID = 00;
    private static Logger Log = LogManager.getLogger(OptimisedLocaltime.class);
    ...
    public static void main(String[] args) {
        try {
            // create persistence
            OptimisedPersistence.getInstance().setFile("transactions.txt");
            ...
            while (s != null && !("".equals(s))) {
                if (isCleanString(s)) {
                    ...
                    if (tr != null) {
                        ...
                        if (OptimisedPersistence.getInstance().writeTransaktion(tr)) {
